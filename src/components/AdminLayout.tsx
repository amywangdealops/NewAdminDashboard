      ...
      items: [
        {
          ...
          icon: Database,
          subnav: [
            { path: "/crm/writeback", label: "Writeback to CRM" },
            { path: "/crm/read", label: "Read from CRM" },
          ],
        },
      ],
    },
  ...
  const sidebarContent = (
    <>
      ...
      <nav className="flex-1 overflow-y-auto py-2 px-2">
        {navSections.map((section, idx) => (
          <div key={section.heading} className={idx > 0 ? 'mt-4' : ''}>
            <div className="px-2.5 pb-1 text-[10px] font-semibold uppercase tracking-wider text-[#b0afa8]">
              {section.heading}
            </div>
                        ...
                        {item.subnav.map((subitem) => {
                          ...
                          return (
                            <NavLink
                              ...
                              to={subitem.path}
                              className={`
                                block px-2 py-[4px] rounded text-[12px] transition-all duration-150
                                ${isSubActive
      ...
      <div className="px-3 pb-3 pt-2 border-t border-[#e2e0d8]">
        <a href="#" className="flex items-center gap-1.5 px-2.5 py-1.5 text-[11px] text-[#999891] hover:text-[#666666] transition-colors">
